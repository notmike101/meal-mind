...
<template>
  <div class="mm-panel flex flex-col mm-gap-4 mm-p-5 sm:flex-row sm:items-center sm:justify-between">
    <div class="flex items-center mm-gap-3">
      ...
      <div>
        <h2 class="mm-text-lg font-bold">{{ plan.weekStart }} through {{ plan.weekEnd }}</h2>
    ...
    <span :class="locked ? 'bg-field text-ink/70' : 'bg-moss/10 text-moss'" class="inline-flex items-center mm-gap-2 self-start rounded-full mm-px-3 mm-py-2 mm-text-sm font-bold sm:self-center">
