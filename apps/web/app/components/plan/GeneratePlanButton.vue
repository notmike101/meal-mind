      ...
      <section role="dialog" aria-modal="true" aria-labelledby="generate-plan-heading" class="mm-panel w-full mm-max-w-md mm-p-6 shadow-xl">
        ...
        <form class="mm-mt-5 mm-space-y-4" @submit.prevent="generate">
          <label class="block mm-space-y-2">
            ...
            <input v-model.number="mealCount" type="number" min="1" required class="focus-ring mm-field w-full mm-px-3 mm-py-2" />
          </label>
          ...
          <div class="flex justify-end mm-gap-2">
            <button type="button" class="focus-ring mm-button-secondary mm-px-4 mm-py-2 mm-text-sm font-semibold" @click="open = false">Cancel</button>
